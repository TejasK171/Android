...
class ActivationJourneryAdapter(
    private val activity: MainActivity?,
    private val activationJourneyMap: Map<String, Any>,
    ...
    override fun onBindViewHolder(holder: OrderJouneryViewholder, position: Int) {
        try {
            var activationData : HashMap<String, Any>? = null
...
//                holder.txtTvPendingCount!!.text = activationData["tv_pending"].toString()
            ...
            holder.txtLessDetails!!.setOnClickListener {
                if(holder.cnstrntLHiddenRow!!.visibility== View.VISIBLE){
                    ...
                    holder.txtLessDetails!!.text = activity.getString(R.string.hidedetails)
                    holder.cnstrntL_inProcess!!.visibility = View.GONE
           ...
           //  holder.cnstrntL_inProcess!!.visibility=View.GONE
            ...
            holder.card4!!.setOnClickListener {
                    ...
                    fetchData(holder,Busicode.O2ARejected,1,position)
            ...
            holder.card5!!.setOnClickListener {
                    ...
                    fetchData(holder,Busicode.O2AInProcess,0,position)
...
//
    ...
    fun fetchData(
        ...
        if(position==0){
            requestBody["channel"] = "ALL"
        }else if(position==1){
            requestBody["channel"] = "GT"
        }else{
            requestBody["channel"] = "RR"
        }
//        requestBody["zone"] = ""
//        requestBody["region"] = ""
