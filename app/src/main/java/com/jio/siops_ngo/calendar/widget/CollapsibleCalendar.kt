package com.jio.siops_ngo.calendar.widget
...
import com.jio.siops_ngo.calendar.data.CalendarAdapter
import com.jio.siops_ngo.calendar.data.Day
import com.jio.siops_ngo.calendar.data.Event
import com.jio.siops_ngo.calendar.view.BounceAnimator
import com.jio.siops_ngo.calendar.view.ExpandIconView
...
class CollapsibleCalendar : UICalendar, View.OnClickListener {
    ...
    fun prevMonth() {
        val cal = mAdapter!!.calendar
        params.let {
            if (it != null && (Calendar.getInstance().get(Calendar.YEAR) * 12 + Calendar.getInstance().get(
                    Calendar.MONTH
                ) + it.prevDays / 30) > (cal.get(Calendar.YEAR) * 12 + cal.get(Calendar.MONTH))
            ) {
            ...
            if (cal.get(Calendar.MONTH) == cal.getActualMinimum(Calendar.MONTH)) {
                ...
                val diff = Calendar.getInstance().get(Calendar.MONTH) - cal.get(Calendar.MONTH)
                if (Calendar.getInstance().get(Calendar.MONTH) == cal.get(Calendar.MONTH))
    ...
    fun nextMonth() {
        ...
        params.let {
            if (it != null && (Calendar.getInstance().get(Calendar.YEAR) * 12 + Calendar.getInstance().get(
                    Calendar.MONTH
                ) + it.nextDaysBlocked / 30) < (cal.get(Calendar.YEAR) * 12 + cal.get(Calendar.MONTH))
            ) {
                val myAnim = AnimationUtils.loadAnimation(context, R.anim.bounce)
                val interpolator = BounceAnimator(0.1, 10.0)
                myAnim.setInterpolator(interpolator)
    ...
    var params: Params? = null
        /*get() {
            ...
            return Params(
                params!!.prevDays, params!!.nextDaysBlocked
                )
        }*/
        set(value) {
            field = value
