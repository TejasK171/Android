        ...
        if (attrs != null) {
            ...
            try {
                ...
                setAnimationTime(animationTime = a.getInteger(
                        R.styleable.DotProgressBar_durations,
                        resources.getInteger(android.R.integer.config_mediumAnimTime)
                ).toLong())
                setStartColor(
                        a.getInteger(
                                R.styleable.DotProgressBar_startColor,
                                ContextCompat.getColor(context, R.color.blue_faint)
                        )
                )
                setEndColor(
                        a.getInteger(
                                R.styleable.DotProgressBar_endColor,
                                ContextCompat.getColor(context, R.color.button_bg_color)
                        )
                )
            ...
            setStartColor(ContextCompat.getColor(context, R.color.light_blue_A700))
            setEndColor(ContextCompat.getColor(context, R.color.light_blue_A400))
