...
class ResourceProductivityLiveShiftAdapter(val mainActivity: MainActivity?, val shiftDomainIdDataMap: HashMap<String, List<Map<String, Any>>>, val shiftsList:ArrayList<String>, val shiftCitrixSessionDataMap: HashMap<String, List<Map<String, Any>>>,
                                           val shiftNgoSessionDataMap: HashMap<String, List<Map<String, Any>>>, val shiftAlertDataMap: HashMap<String, List<Map<String, Any>>>) : RecyclerView.Adapter<ProductivityShiftRecyclerViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viwType: Int): ProductivityShiftRecyclerViewHolder {
        var view: View?

        view = LayoutInflater.from(parent.context).inflate(R.layout.producatvity_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ProductivityShiftRecyclerViewHolder, position: Int) {
        try {
            ...
            var resourceProductivityShiftAdapter = ResourceProductivityShiftItemAdapter(mainActivity, shiftDomainIdtList!!, shiftCitrixSessionList!!, shiftNgoSessionList!!, shiftAlertList!!)
            ...
            holder!!.live_moring_list!!.adapter = resourceProductivityShiftAdapter
