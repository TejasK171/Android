...
class StateCustomDropDownAdapter(val activity: MainActivity?, var regionlist: ArrayList<Map<String, Any>>?) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            view = mInflater.inflate(R.layout.state_spiner_item, parent, false)
