...
class ThroughtPutAdapter (private val activity: MainActivity?) : RecyclerView.Adapter<InfraAlarmsReasonViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viwType: Int): InfraAlarmsReasonViewHolder {
        ...
        view = LayoutInflater.from(parent.context).inflate(R.layout.throught_put_item, parent, false)
