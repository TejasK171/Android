...
class FilteraImpactedCustomerAdapter(private val pos:String,private val mImpactedCustomerInterfaceFilterName:ImpactedCustomerInterfaceFilterName, private  val list: ArrayList<Map<String, Any>>?, private val activity: MainActivity?) : RecyclerView.Adapter<InfraFilterViewHolder>() {

    private var selected: RadioButton? = null



    interface ImpactedCustomerInterfaceFilterName {

        fun impactedClickInterface(value:String,start_rang:String,end_rang:String)
    }
           ...
           var name= content!!["name"].toString()
            ...
            holder.radioButton!!.setOnClickListener {
                ...
                selected = holder.radioButton
                  ...
                  mImpactedCustomerInterfaceFilterName.impactedClickInterface(position.toString(),content!!["start_rang"].toString(), content!!["end_rang"].toString())
