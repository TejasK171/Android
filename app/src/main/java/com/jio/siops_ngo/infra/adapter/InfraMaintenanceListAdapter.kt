...
import com.jio.siops_ngo.infra.fragment.InfraSiteHistoryFragment
import com.jio.siops_ngo.viewholder.OpenAlarmsViewHolder
import java.lang.Exception

class InfraMaintenanceListAdapter(
...
) : RecyclerView.Adapter<OpenAlarmsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: OpenAlarmsViewHolder, position: Int) {
        try {
            ...
            holder.imgDropDown!!.setOnClickListener {
                ...
                var infraNotificationFragment = InfraSiteHistoryFragment.newInstance()
                infraNotificationFragment.setData(commonBeanNew,outLierId,name,holder.txtTitle!!.text.toString().trim(),catagry!!,mFilterGetterAndSetter!!)
        ...
        try {
            ...
            if (msg != null) {
                try {
                    ...
                    var adapter = NgoAlarmSubAdapter(dataListNgoItem!!, activity as MainActivity?)
