...
class FilteraWorkOrderAdapter(private  val pos:String,private val mWorkerOrderInterfaceFilterName:WorkerOrderInterfaceFilterName,private  val list: ArrayList<Map<String, Any>>?, private val activity: MainActivity?) : RecyclerView.Adapter<InfraFilterViewHolder>() {

    private var selected: RadioButton? = null



    interface WorkerOrderInterfaceFilterName {

        fun workerOrderClickInterface(value:String,start_rang:String,end_rang:String)
    }
        ...
        try {
           ...
           var name= content!!["name"].toString()
            ...
            holder.radioButton!!.setOnClickListener {
                ...
                selected = holder.radioButton
                 mWorkerOrderInterfaceFilterName.workerOrderClickInterface(position.toString(),content!!["start_rang"].toString(), content!!["end_rang"].toString())
            }
        }catch (e: Exception){
            e.printStackTrace()
        }
