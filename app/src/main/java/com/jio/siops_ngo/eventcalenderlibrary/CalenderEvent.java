package com.jio.siops_ngo.eventcalenderlibrary;
...
import com.jio.siops_ngo.eventcalenderlibrary.helper.PreferenceHelper;
import com.jio.siops_ngo.eventcalenderlibrary.listener.CalenderDayClickListener;
import com.jio.siops_ngo.eventcalenderlibrary.model.DayContainerModel;
import com.jio.siops_ngo.eventcalenderlibrary.helper.TimeUtil;
import com.jio.siops_ngo.eventcalenderlibrary.model.Event;
...
//        int nextMonthDays = 42 - (daysInCurrentMonth + previousLeftMonthDays);
        ...
        int nextMonthDays = Integer.parseInt(formattedDate);


        int currentMonthDays = Integer.parseInt(formattedDate);
        int prevCurrentDays = mCalendar.getActualMaximum(Calendar.DAY_OF_MONTH) - currentMonthDays;
...
//        if (previousLeftMonthDays != 0) {
            ...
            mCalendar.set(prevYear, prevMonth, (previousMonthTotalDays - nextMonthDays));
            int prevCurrentDay = mCalendar.get(Calendar.DATE);
            prevCurrentDay++;
        for (int i = 0; i < prevCurrentDays; i++) {
...
//                days[index].setBackgroundColor(mContext.getResources().getColor(R.color.light_grey));
                days[index].setTextColor(mContext.getResources().getColor(R.color.white));
//                days[index].setPadding(0, 25, 0, 0);
                LinearLayout lnr = (LinearLayout) ((ViewGroup) days[index].getParent());
                lnr.setBackgroundColor(mContext.getResources().getColor(R.color.light_grey));
                ...
                days[index].setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        daysContainer[finalIndex].setBackgroundResource(R.drawable.blue_background);
        ...
        for (int i = 1; i <= daysInCurrentMonth; i++) {
            ...
            if(i<nextMonthDays){
                ...
                LinearLayout lnr = (LinearLayout) ((ViewGroup) days[index].getParent());
                lnr.setBackgroundColor(mContext.getResources().getColor(R.color.white));
...
//                daysContainer[index].setBackgroundResource(R.drawable.blue_background);
...
//                linearLayout.setGravity(Gravity.CENTER_HORIZONTAL);
                ...
                day.setSingleLine();
                day.setPadding(0, 25, 0, 0);
                day.setGravity(Gravity.CENTER_VERTICAL|Gravity.CENTER);
