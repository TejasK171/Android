...
class EnergyDataCompletsMissingListAdapter(mainActivity: MainActivity?) : RecyclerView.Adapter<DcbOnClickItemHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viwType: Int): DcbOnClickItemHolder {
        var view: View?

        view = LayoutInflater.from(parent.context).inflate(R.layout.site_missing_item, parent, false)
