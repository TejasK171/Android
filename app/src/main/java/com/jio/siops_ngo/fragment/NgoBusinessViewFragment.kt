...
class NgoBusinessViewFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = NgoBusinessViewFragment()
    }
    ...
    override fun onCreateView(
        ...
        mBinding!!.txtActivationsTrend.setOnClickListener {

            if (mBinding!!.ngoActivationsTrendRv.visibility == View.VISIBLE) {
                mBinding!!.ngoActivationsTrendRv.visibility = View.GONE
            } else {
                mBinding!!.ngoRechargeTrendRv.visibility = View.GONE
                mBinding!!.ngoMnpTrendRv.visibility = View.GONE
                mBinding!!.ngoMacdRv.visibility = View.GONE
        ...
        mBinding!!.txtRechargeTrend.setOnClickListener {

            if (mBinding!!.ngoRechargeTrendRv.visibility == View.VISIBLE) {
                mBinding!!.ngoRechargeTrendRv.visibility = View.GONE
            } else {
                mBinding!!.ngoActivationsTrendRv.visibility = View.GONE
                mBinding!!.ngoMnpTrendRv.visibility = View.GONE
        ...
        mBinding!!.txtMnpTrend.setOnClickListener {

            if (mBinding!!.ngoMnpTrendRv.visibility == View.VISIBLE) {
                mBinding!!.ngoMnpTrendRv.visibility = View.GONE
            } else {
                mBinding!!.ngoActivationsTrendRv.visibility = View.GONE
                mBinding!!.ngoRechargeTrendRv.visibility = View.GONE
                mBinding!!.ngoMacdRv.visibility = View.GONE
                if (portInPortOutTrendDataList != null) {
        ...
        mBinding!!.txtMacdTrend.setOnClickListener {

            if (mBinding!!.ngoMacdRv.visibility == View.VISIBLE) {
                mBinding!!.ngoMacdRv.visibility = View.GONE
            } else {
                mBinding!!.ngoActivationsTrendRv.visibility = View.GONE
                mBinding!!.ngoMnpTrendRv.visibility = View.GONE
                mBinding!!.ngoRechargeTrendRv.visibility = View.GONE
                if (macdTrendDataList != null) {
        ...
        /*val gson =  Gson();
        val usefulLinksBusinessJson = PreferenceUtility.getString(activity!!, MyConstants.USEFUL_LINKS_INFRA, "")

        val typeToken = object : TypeToken<ArrayList<Map<String, Any>>>() {}.type

        usefulLinksBusiness = gson.fromJson(usefulLinksBusinessJson, typeToken) as ArrayList<Map<String, Any>>*/


        /*var adapter = UsefulLinksAdapter(
            commonBean!!.usefulLinksBusinessView!! as List<Map<String, Any>>,
            activity as MainActivity,
            commonBean!!
        )*/
