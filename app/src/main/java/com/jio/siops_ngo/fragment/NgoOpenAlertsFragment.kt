 ...
 */
class NgoOpenAlertsFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = NgoOpenAlertsFragment()
    }
...
*/
    ...
    fun changeSelection(selection: Int){
        ...
        var adapter = NgoOpenAlarmsAdapter(Busicode.NGOOnclickType, openAlertsDataList!!, activity as MainActivity?)
